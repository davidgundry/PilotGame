...
namespace menu.pregame
{
    public class LevelSelectMenuBehaviour : UIPane
    {
        ...
        void Start()
        {
            ...
            {
                Debug.LogWarning("No GameController found. This is probably because you are running the game without loading from the first menu. Trying to instantiate a new Game Controller");
